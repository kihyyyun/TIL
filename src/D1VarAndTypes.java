...
public class D1VarAndTypes {
    public static void main(String[] args) {
        ...
        // b 라는 이름에 상자에 "Hello Veriables!"라는 데이터를 넣어준다.
        String b = "Hello Veriables!";
        //b에 들어있는게 뭔지 확인한다.
        ...
        int cageemocha = 4000;
        // 아메리카노 5잔 가격 출력;
        // 카푸치노 3잔 + 카페라떼 2잔 가격출력
        // 카페모카 1잔 + 아메리카노 3잔 가격줊력

        System.out.println( americano * 5);
        System.out.println( cappuccino * 3 + caffeLatte * 2);
        System.out.println(cageemocha + americano * 3);
        ...
        long integer = 1000000000000L;
        short smallIntegar =10000;
        ...
        // 진짜 긴 소수는?
        double longPi = 3.14159265359799489;
...
//        System.out.println(String.format("미세먼지 농도: %d (%s)",dust, status));
        ...
        String word1 = "Hello : %d (%s)" ;
        System.out.println(String.format(word1,dust, status));
